<?php
    function db_connect($iata, $name, $city, $stat){
        $server="localhost";
        $db_username="root";
        ...
        <h1> <br><br><br></h1>
        <br><br><br>
        <h1 style= "font-size: 65px;font-family: Staatliches;text-align:center;">The following airport has been inserted into database:</h1>
...
EOT;
        ...
        $q = "insert into data values ('$iata', '$name', '$city', '$stat', null, null);";
