<?php
    function db_connect($state){
        ...
        <h1> <br><br><br></h1>
        <br><br><br>
        <h1 style= "font-size: 65px;font-family: Staatliches;text-align:center;">Airport with the iata code has been deleted!: '$state'</h1>
...
EOT;
        ...
        $q = "delete from data where iata_code = '$state'";
